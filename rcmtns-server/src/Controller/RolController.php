...
class RolController extends Controller
{
    ...
    {
        return $this->render('rol/index.html.twig', ['rols' => $rolRepository->findAll()]);
    }
    ...
    {
        return $this->render('rol/show.html.twig', ['rol' => $rol]);
    }
    ...
    public function edit(Request $request, Rol $rol): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('rol_edit', ['id' => $rol->getId()]);
        }
